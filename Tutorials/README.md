...
## 1. Introduction
This manual implements the bOSsin' operating system and the bossin' (notice that "os" is not capital) bootloader.

Right now, there is not much to this section since the OS is actively under development by me. You can view the goals [here](GOALS.md).
...
## 1.4 Some Hard Truths [SECTION SUBJECT TO CHANGE; this will be updated] [[3]](#3)
...
**Printing text, and interacting with some hardware does not make your software an OS.** This is a beginner's mistake. Arguably, when I abandoned OS development last time, I was guilty of this mistake as well. Then I realized that printing some text in some virtualized environment does not make an OS, there are countless other concepts that you have to implement to actually be able to say "I created an OS.". Reading this manual will enable you to say this [when such chapters are available, hence learned by me].
...
I am always open to discussions, requests on any content you see in this guide, any portion of the source code, or the (future) website.
...
Any feedback is very welcome, please propose changes, create PRs for the source code or the manual itself. However, I only ask that you let me know through the matrix room at: [#bossin-chat:matrix.org](https://matrix.to/#/#bossin-chat:matrix.org). Otherwise I will not see your request. See 1.5 for more information.
...
<a id="3">[3]</a> See <https://wiki.osdev.org/Beginner_Mistakes> for more specific mistakes, it will be useful.
